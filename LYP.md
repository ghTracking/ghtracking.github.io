...
* Organic matter in photosynthetic organisms contains less $^{13}C$ in comparison with surrounding sediments, causing fractionation and known as the kinetic isotope effect.
* Similarly, biological sulfate reduction shows a preference for $^{32}S$. Consequently, the sedimentary record may show a greater abundance of this isotope. This is due to the fact that the sulfate atoms are converted to hydrogen sulfide, which then reacts to form pyrite and enters the sedimentary record.
...
* Paper which outlined evidence for life in Isua: Nutman et al (2016) *
* Paper which critically analysed evidence for life in Isua: Allwood et al(2018) *
