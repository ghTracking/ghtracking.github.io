...
## Give an example of a cycloaddition reaction
Diels-Alder

## Give an example of an electrocyclic reaction

## Give examples of sigmatropic reactions
Claisen rearrangement. e.g. [3,3]-sigmatropic (ether to carbonyl, which forms alcohol through keto-enol tautomerism)

## Give examples of group transfer reactions.
Ene reaction.
